module.exports = {
  ...
  exits: {
    success: {
      description: "Password successfully updated, and requesting user agenet automatically logged in.",
    },

    invalidToken: {
      statusCode: 401,
      description: "The provided password token is invalid, expired, or already has been used.",
    }
  },
  ...
  fn: async function (inputs, exits) {
    ...
    await User.updateOne({ id: parseInt(user.id) }).set({
